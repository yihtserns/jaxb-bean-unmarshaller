 ...
 * @author yihtserns
 */
class BeanUnmarshaller implements ElementUnmarshaller.InitializableUnmarshaller {
    ...
    protected BeanUnmarshaller(Class<?> beanClass) throws Exception {
        this(beanClass.getDeclaredConstructor());
    }
    ...
    public <T extends AccessibleObject> void addElements(
            ...
            ElementUnmarshaller.Provider unmarshallerProvider) throws Exception {
        ...
        if (elementWrapper != null) {
            ...
            WrapperUnmarshaller wrapperUnmarshaller = newWrapperUnmarshaller();
            for (XmlElement xmlElement : xmlElements) {
                ElementUnmarshaller childUnmarshaller = resolveUnmarshaller(resolver, accObj, xmlElement, unmarshallerProvider);
    ...
    protected WrapperUnmarshaller newWrapperUnmarshaller() {
        return new WrapperUnmarshaller();
    }
    ...
    private <T extends AccessibleObject> ElementUnmarshaller resolveUnmarshaller(
            PropertyResolver<T> resolver,
            T accObj,
        ...
        if (accObj.isAnnotationPresent(XmlJavaTypeAdapter.class)) {
            ...
            ElementUnmarshaller unmarshaller = unmarshallerProvider.getUnmarshallerForType(valueType);
    ...
    public <T extends AccessibleObject> void addElementRef(
            ...
            ElementUnmarshaller.Provider unmarshallerProvider) {
        ...
        unmarshallerProvider.forGlobalUnmarshallerCompatibleWith(propertyType, new Provider.Handler() {
            public void handle(String globalName, ElementUnmarshaller unmarshaller) {
