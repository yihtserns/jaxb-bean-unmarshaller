...
class BeanUnmarshaller implements ElementUnmarshaller.InitializableUnmarshaller {
    ...
    Map<String, Unmarshaller<Attr>> attributeName2Unmarshaller = new HashMap<String, Unmarshaller<Attr>>();
    Map<String, Unmarshaller<Element>> localName2Unmarshaller = new HashMap<String, Unmarshaller<Element>>();
    ...
    public <T extends AccessibleObject> void addAttribute(T accObj, PropertyResolver<T> resolver) throws Exception {
        ...
        Unmarshaller<Attr> unmarshaller = AttrUnmarshaller.GET_VALUE;
