 ...
 * @author yihtserns
 */
public class SpringBeanHandlerTest extends AbstractSpecTest {
    ...
    public void canResolvePropertyPlaceholders() throws Exception {
        ...
        Root root = unmarshal(xml, Root.class, AbstractSpecTest.JaxbObject.class, AbstractSpecTest.JaxbObject2.class, AbstractSpecTest.Message.class, AbstractSpecTest.Annotation.class);
        {
